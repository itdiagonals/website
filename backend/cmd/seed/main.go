...
func seedCategories(db *gorm.DB, store *storage.MinioStorage, ctx context.Context, imagesDir string) {
	items := []struct {
		...
		{"Jerseys", "jerseys", "products-1.png"},
		{"Shorts", "shorts", "products-2.png"},
		{"Accessories", "accessories", "products-3.png"},
		{"Training", "training", ""},
	}
...
func seedProducts(db *gorm.DB, store *storage.MinioStorage, ctx context.Context, imagesDir string, seasons []domain.Season) {
	...
	products := []struct {
	...
	}{
		{
			...
			GalleryFiles: []string{"jersey-main.png", "jersey-thumb-1.png", "jersey-thumb-2.png", "jersey-thumb-3.png"},
			Variants: []domain.ProductVariant{
		...
		},
		{
			...
			GalleryFiles: []string{"products-2.png"},
			Variants: []domain.ProductVariant{
