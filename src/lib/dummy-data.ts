...
export const categories: Category[] = [
  {
    ...
    slug: "jerseys",
    coverImageId: 10,
    coverImage: { id: 10, url: "/categories/jerseys.webp", alt: "Jerseys category" },
  ...
  },
  {
    ...
    slug: "shorts",
    coverImageId: 11,
    coverImage: { id: 11, url: "/categories/shorts.webp", alt: "Shorts category" },
  ...
  },
  {
    ...
    slug: "socks",
    coverImageId: 12,
    coverImage: { id: 12, url: "/categories/socks.webp", alt: "Socks category" },
  ...
  },
  {
    ...
    slug: "accessories",
    coverImageId: 13,
    coverImage: { id: 13, url: "/categories/accessories.webp", alt: "Accessories category" },
  ...
  },
  {
    ...
    slug: "training",
    coverImageId: 14,
    coverImage: { id: 14, url: "/categories/training.webp", alt: "Training category" },
...
export const seasons: Season[] = [
  {
    ...
    coverImageId: 20,
    coverImage: { id: 20, url: "/seasons/el-ligue-premiere.webp", alt: "El Ligue Premiere" },
    isActive: true,
    lookbookImages: [
      { id: 21, url: "/products/season-1.webp", alt: "Look 1" },
      { id: 22, url: "/products/season-3.webp", alt: "Look 2" },
    ],
  ...
  },
  {
    ...
    coverImageId: 23,
    coverImage: { id: 23, url: "/seasons/summer-drop.webp", alt: "Summer Drop 2024" },
    isActive: false,
    lookbookImages: [
      { id: 24, url: "/seasons/summer-1.webp", alt: "Look 1" },
    ],
  ...
  },
  {
    ...
    coverImageId: 25,
    coverImage: { id: 25, url: "/seasons/winter-collection.webp", alt: "Winter Collection" },
    isActive: false,
    lookbookImages: [],
  ...
  },
  {
    ...
    coverImageId: 26,
    coverImage: { id: 26, url: "/seasons/heritage-line.webp", alt: "Heritage Line" },
    isActive: false,
    lookbookImages: [
      { id: 27, url: "/seasons/heritage-1.webp", alt: "Look 1" },
      { id: 28, url: "/seasons/heritage-2.webp", alt: "Look 2" },
    ],
...
export const products: Product[] = [
  {
    ...
    coverImageId: 1,
    coverImage: { id: 1, url: "/products/products-1.webp", alt: "El Ligue Home Jersey" },
    ...
    gallery: [
      { id: 1, imageUrl: "/products/products-1.webp", sortOrder: 1 },
      { id: 2, imageUrl: "/products/products-1.webp", sortOrder: 2 },
    ],
    variants: [
  ...
  },
  {
    ...
    coverImageId: 2,
    coverImage: { id: 2, url: "/products/products-2.webp", alt: "El Ligue Away Jersey" },
    ...
    gallery: [
      { id: 3, imageUrl: "/products/products-2.webp", sortOrder: 1 },
    ],
    variants: [
  ...
  },
  {
    ...
    coverImageId: 3,
    coverImage: { id: 3, url: "/products/products-1.webp", alt: "Summer Training Shorts" },
    ...
    availableSizes: [defaultSizes[1], defaultSizes[2], defaultSizes[3]],
    gallery: [
      { id: 4, imageUrl: "/products/products-1.webp", sortOrder: 1 },
    ],
    variants: [
  ...
  },
  {
    ...
    coverImageId: 4,
    coverImage: { id: 4, url: "/products/products-1.webp", alt: "Performance Socks Pack" },
    ...
    gallery: [
      { id: 5, imageUrl: "/products/products-1.webp", sortOrder: 1 },
    ],
    variants: [
  ...
  },
  {
    ...
    coverImageId: 5,
    coverImage: { id: 5, url: "/products/products-1.webp", alt: "Heritage Scarf" },
    ...
    availableSizes: [],
    gallery: [
      { id: 6, imageUrl: "/products/products-1.webp", sortOrder: 1 },
    ],
    variants: [
  ...
  },
  {
    ...
    coverImageId: 6,
    coverImage: { id: 6, url: "/products/products-1.webp", alt: "Training Bib Set" },
    ...
    availableSizes: [],
    gallery: [
      { id: 7, imageUrl: "/products/products-1.webp", sortOrder: 1 },
    ],
    variants: [
  ...
  },
  {
    ...
    coverImageId: 7,
    coverImage: { id: 7, url: "/products/products-1.webp", alt: "Winter Training Jacket" },
    ...
    gallery: [
      { id: 8, imageUrl: "/products/products-1.webp", sortOrder: 1 },
    ],
    variants: [
  ...
  },
  {
    ...
    coverImageId: 8,
    coverImage: { id: 8, url: "/products/products-1.webp", alt: "Match Day Kit Bag" },
    ...
    availableSizes: [],
    gallery: [
      { id: 9, imageUrl: "/products/products-1.webp", sortOrder: 1 },
    ],
    variants: [
