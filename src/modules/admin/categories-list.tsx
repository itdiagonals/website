    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-neutral-700 mt-1">Manage product categories</p>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-neutral-300 bg-neutral-200">
                ...
                <th className="px-5 py-3 text-center text-xs font-bold uppercase tracking-wide text-neutral-800">Products</th>
                <th className="px-5 py-3 text-right text-xs font-bold uppercase tracking-wide text-neutral-800">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-neutral-300">
              {filteredCategories.map((category) => (
                <tr key={category.id} className="hover:bg-neutral-200 transition-colors">
                  <td className="px-5 py-3 font-medium text-primary-1000">{category.name}</td>
                  <td className="px-5 py-3 text-neutral-700 font-mono text-xs">{category.slug}</td>
                  <td className="px-5 py-3 text-center">
                    <span className="rounded-full bg-neutral-200 px-2.5 py-0.5 text-xs font-medium text-primary-800">
